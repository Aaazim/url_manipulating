...
if __name__ == '__main__':
	...
	print append_query_string('http://google.com', foo="foo", name="aazim")
	print append_query_string('http://google.com?bar=bar', foo="foo", name="aazim")
	print update_query_string('http://google.com?bar=bar&foo=foo&name=aazim', 'foo', 'india')
